== Welcome to jMFB
jMFB is program to translate MIUI v4 android firmwares

== Getting Started
1. {Download}[link:KDGDev/jMFB-program/zipball/master] newest distributive

2. Unpack ZIP file to folder with path without spaces

3. [nix users: Make files in /aApps/nix/ executable]
